...
// counts how many times the indicator function returns false when the addChildren funciton is called and re-runs the addChildren function if the number of false results is not 0
